...
st.markdown("<h6 style = 'top_margin: 0rem; color: #F2921D'>Built by Matthew Osabhue</h6>", unsafe_allow_html = True)

st.image('facial.png', caption = 'Built by Matthew Osabhue', width=400)
